...
export default function SectionAbout() {
     return (
          <section
               id="About"
               className="flex flex-row justify-center items-center pt-44 min-h-screen bg-[url(/img/bg-light-radial.png),url(/img/bg-light-1.png),url(/img/bg-light-2.png)] [background-position:70%_40%,0%_0%,100%_50%] bg-no-repeat"
          >
